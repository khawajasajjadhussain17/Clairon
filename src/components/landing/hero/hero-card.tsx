...
export function HeroCard() {
  return (
    <div className="relative mt-8 w-full min-w-0 max-w-[1000px] bg-transparent p-0 shadow-none sm:mt-12">
      ...
      <div className="aspect-auto overflow-visible rounded-2xl bg-transparent p-0">
        <Image
      ...
      <button
        type="button"
        className="absolute left-1/2 top-1/2 flex size-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/30 bg-white/20 backdrop-blur-[20px] sm:size-20 md:size-[88px]"
