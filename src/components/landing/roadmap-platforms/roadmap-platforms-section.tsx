...
function Svg1() {
  /* Match style used by Svg2/Svg3: inline svg + text labels */
  return (
    <svg
      width="576"
      height="175"
    ...
    >
      ...
      {/* Vector path labels (same treatment as public/assets/1.svg for crisp rendering) */}
...
const STEP1_LEFT = 24           // left padding
...
const STEP3_TOP = STEP2_TOP + 64 + (85 - 9) + 62  // align step 3 heading with {003} connector dot
const STEP3_LEFT = 24

// Keep Step 4 on the same right column as Step 2.
