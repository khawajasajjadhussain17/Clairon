  ...
  return (
    <div className="landing-font-root flex min-h-0 flex-1 flex-col overflow-x-clip">
      <main id="top" className="flex min-h-0 flex-1 flex-col bg-white overflow-x-clip">
        <div className="relative isolate min-h-[100dvh] min-h-screen overflow-x-clip bg-[linear-gradient(to_bottom,#ffffff_0%,#f8fafc_12%,#eef4ff_28%,#dbeafe_48%,#bfdbfe_68%,#93c5fd_82%,#60a5fa_92%,#3b82f6_100%)] before:pointer-events-none before:absolute before:inset-0 before:z-[1] before:bg-[linear-gradient(to_bottom,rgba(255,255,255,0.7)_0%,rgba(255,255,255,0.3)_25%,transparent_50%)] after:pointer-events-none after:absolute after:bottom-[-6%] after:left-1/2 after:z-0 after:h-[62%] after:w-[120%] after:max-w-[180vw] after:-translate-x-1/2 after:bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.88)_0%,rgba(219,234,254,0.5)_28%,rgba(147,197,253,0.2)_50%,transparent_68%)] after:blur-[56px]">
          <SiteHeader />
          <div
            className="pointer-events-none absolute inset-x-0 bottom-[5%] z-[1] flex justify-center opacity-70 [mask-image:linear-gradient(to_top,black_72%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_top,black_72%,transparent_100%)]"
            aria-hidden
          >
            <Image
              ...
              height={668}
              unoptimized
              className="h-auto w-full max-w-[1180px] object-contain object-bottom"
            />
          </div>
          <section
